...
#ifndef AVFORMAT_LIBRMHD_H
#define AVFORMAT_LIBRMHD_H
...
extern const char * const ff_librmhd_metadata[4];
extern const AVCodecTag ff_librmhd_codec_tags[];
 ...
 *         data is available by calling ff_librmhd_retrieve_cache().
 */
int ff_librmhd_parse_packet (AVFormatContext *s, AVIOContext *pb,
 ...
 */
int ff_librmhd_retrieve_cache (AVFormatContext *s, AVIOContext *pb,
                          AVStream *st, RMStream *rst, AVPacket *pkt);

#endif /* AVFORMAT_LIBRMHD_H */
